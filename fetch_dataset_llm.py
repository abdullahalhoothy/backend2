...
async def process_llm_query(req:ReqLLMFetchDataset):
    ...
    - MUST HAVE: Exactly one approved city name in the query from Approved Cities
    ...
    6. Reference place categories not in the approved list
    7. Mention countries not in the approved list
