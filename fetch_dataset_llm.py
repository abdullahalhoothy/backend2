...
# Fetch and check data before using it
...
def calculate_cost(Request: ReqLLMDataset)->ReqLLMDataset:
...
def extract_location_info(Request: ReqLLMDataset) -> ReqLLMDataset:
    """
