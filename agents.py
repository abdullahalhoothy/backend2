...
class ExplanationAgent:
    ...
    #key=os.environ["DEEPSEEK_API_KEY"]
      api_key="AIzaSyCUl7srT85A9PAaFBHs3ZCz0AvrzWcovoU" #os.environ["GEMINI_API_KEY"]# YOur API KEY
...
class ReqGradientColorBasedOnZoneAgent:
  ...
  def __getmodel(self):
    #key=os.environ["DEEPSEEK_API_KEY"]
    api_key="AIzaSyCUl7srT85A9PAaFBHs3ZCz0AvrzWcovoU" #os.environ["GEMINI_API_KEY"]
    base_url="https://generativelanguage.googleapis.com/v1beta"
    client=ChatOpenAI(
        base_url=base_url,
        api_key=api_key,
